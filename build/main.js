...
var getBody = __webpack_require__(60)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_sql__ = __webpack_require__(34);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__crypto__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__multer__ = __webpack_require__(39);
...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_nuxt__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_cookie_parser__ = __webpack_require__(112);
...
var expressWinston = __webpack_require__(32);
// import {
//     startRouter
// } from './api/index'

let nuxtConfig = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__account__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__topic__ = __webpack_require__(42);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mysql__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mysql___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mysql__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_index__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_utils_date__ = __webpack_require__(40);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_index__ = __webpack_require__(8);
...
module.exports = {"name":"nuxt-test","version":"1.0.0","description":"Nuxt.js project","author":"xingwen","private":true,"scripts":{"dev":"cross-env NODE_ENV=development backpack dev","dev_old":"nuxt","build":"nuxt build","start":"cross-env NODE_ENV=production pm2 start build/main.js","start_old":"nuxt start","generate":"nuxt generate","lint":"eslint --ext .js,.vue --ignore-path .gitignore .","precommit":"npm run lint","dev-debug":"node --debug node_modules/.bin/nuxt"},"dependencies":{"@types/vue":"^2.0.0","axios":"^0.18.0","cookie-parser":"^1.4.3","crypto":"^1.0.1","element-ui":"^2.4.8","express":"^4.16.4","express-winston":"^3.0.1","github-markdown-css":"^2.10.0","mavon-editor":"^2.6.17","mockjs":"^1.0.1-beta3","multer":"^1.4.1","mysql":"^2.16.0","nuxt":"^1.0.0","vue-markdown":"^2.2.4","vue-meditor":"^0.9.2","vue-meta":"^1.5.5","winston":"^3.1.0"},"devDependencies":{"@nuxtjs/axios":"^5.3.1","@nuxtjs/proxy":"^1.2.4","babel-eslint":"^8.2.1","backpack-core":"^0.7.0","cross-env":"^5.2.0","eslint":"^4.15.0","eslint-friendly-formatter":"^3.0.0","eslint-loader":"^1.7.1","eslint-plugin-vue":"^4.0.0","less":"^3.7.1","less-loader":"^4.1.0"}}
...
var unpipe = __webpack_require__(79)
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(13).concat(__webpack_require__(22)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(13).concat(__webpack_require__(22)) },
        gb18030: function() { return __webpack_require__(74) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(23).concat(__webpack_require__(76)) },
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(82); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(14).concat(__webpack_require__(24)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(25).concat(__webpack_require__(95)) },
        encodeSkipVals: [0xa2cc],
    },
...
function parser (name) {
  ...
  switch (name) {
    case 'qs':
      mod = __webpack_require__(108)
      break
    case 'querystring':
      mod = __webpack_require__(111)
      break
  }
