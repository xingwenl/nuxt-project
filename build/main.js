...
/* WEBPACK VAR INJECTION */(function(__dirname, module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_nuxt__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_body_parser__ = __webpack_require__(42);
...
let nuxtConfig = __webpack_require__(39);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, "server", __webpack_require__(13)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user__ = __webpack_require__(38);


const router = __WEBPACK_IMPORTED_MODULE_0__base__["a" /* default */].Router();
router.use('/user', __WEBPACK_IMPORTED_MODULE_1__user__["a" /* default */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_index___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__utils_index__);
...
class Sql {
	...
	insert(object) {
		...
		if (object) {
			...
			if (__WEBPACK_IMPORTED_MODULE_2__utils_index___default.a.isEmptyObject(object)) {
				console.log('这尼玛是个空值');
				return object;
			}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_crypto__ = __webpack_require__(37);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_index__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_index__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_index___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__utils_index__);


const router = __WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* default */].Router();
const sql = __WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* default */].sql;

router.get('/all_user', async (req, res) => {
    const results = await sql.T('user').search();
    return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* default */].returnJson(200, results, 'success'));
});
// 查询个人信息
router.post('/userinfo', async (req, res) => {
    try {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__utils_index___default.a.isEmpty(token)) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__utils_index___default.a.isEmptyObject(results)) {
            return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* default */].returnJson(200, 'token错误', "登录失效，请重新登录"));
        }

        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* default */].returnJson(200, results[0], "查询成功"));
    } catch (e) {
...
router.post('/register', async (req, res) => {
    try {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__utils_index___default.a.isEmpty(username) || __WEBPACK_IMPORTED_MODULE_1__utils_index___default.a.isEmpty(real_password)) {
        ...
        if (!__WEBPACK_IMPORTED_MODULE_1__utils_index___default.a.isEmptyObject(isExist)) {
            return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* default */].returnJson(10002, 'error', "改账号已存在，请重新输入账号"));
        }

        const password = __WEBPACK_IMPORTED_MODULE_1__utils_index___default.a.sha1(req.body.password);
        ...
        res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* default */].returnJson(200, 'success', "注册成功"));
    } catch (e) {
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* default */].returnJson(10004, e, "服务器错误"));
    }
});
...
router.post('/login', async (req, res) => {
    try {
        ...
        // 获取token
        const token = __WEBPACK_IMPORTED_MODULE_1__utils_index___default.a.hmac(password);
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(11).concat(__webpack_require__(22)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(23).concat(__webpack_require__(73)) },
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(12).concat(__webpack_require__(24)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(25).concat(__webpack_require__(92)) },
        encodeSkipVals: [0xa2cc],
    },
