...
var iconv = __webpack_require__(76)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_index__ = __webpack_require__(15);
...
const sql = __WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* default */].sql.T('account');
...
router.get('/all_user', async (req, res) => {
    try {
        ...
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* default */].returnJson(10005, error, '服务器错误'));
    }
});
// 查询个人信息
...
router.get('/logout', async (req, res) => {
    try {
        ...
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* default */].returnJson(200, null, '退出成功'));
    } catch (error) {
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* default */].returnJson(10006, error, "服务器错误"));
    }
});
...
var bytes = __webpack_require__(3)
var createError = __webpack_require__(4)
var iconv = __webpack_require__(57)
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(11).concat(__webpack_require__(21)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(22).concat(__webpack_require__(72)) },
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(12).concat(__webpack_require__(23)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(24).concat(__webpack_require__(91)) },
        encodeSkipVals: [0xa2cc],
    },
