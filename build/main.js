...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_sql__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils__ = __webpack_require__(4);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_1__utils_sql__["a"]; });
...
/* unused harmony reexport multer */



class Base {
    constructor() {
        this.sql = new __WEBPACK_IMPORTED_MODULE_1__utils_sql__["a" /* default */]();
    }
    ...
    Router() {
        return __WEBPACK_IMPORTED_MODULE_0_express___default.a.Router();
    }
    /**
     *
     *
    ...
    async userinfo(token) {
        let _this = this;
        try {
            if (__WEBPACK_IMPORTED_MODULE_2__utils__["a" /* default */].isEmpty(token)) {
                return this.returnJson(10003, 'token不存在', "未登录");
            }
            const results = await this.sql.T('account').search('id,account', {
                token
            });
            if (__WEBPACK_IMPORTED_MODULE_2__utils__["a" /* default */].isEmptyObject(results)) {
    ...
    // 上传图片的
    multer(desc) {
        return __WEBPACK_IMPORTED_MODULE_2__utils__["b" /* multer */].instance(desc);
    }
...
/* harmony default export */ __webpack_exports__["b"] = (new Base());
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__crypto__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__multer__ = __webpack_require__(41);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_1__multer__["a"]; });
...
class Utils {
	...
	constructor() {
		this.extendClass(this, __WEBPACK_IMPORTED_MODULE_0__crypto__["a" /* default */]);
	}
	...
	isEmpty(o) {
		if (undefined === o || false === o || null === o || '' === o) {
			return true;
		}
		return false;
	}
...
var callSiteToString = __webpack_require__(18).callSiteToString
var eventListenerCount = __webpack_require__(18).eventListenerCount
var relative = __webpack_require__(10).relative
...
var toIdentifier = __webpack_require__(21)
...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_nuxt__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_body_parser__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_body_parser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_body_parser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_cookie_parser__ = __webpack_require__(119);
...
var expressWinston = __webpack_require__(34);
// import {
//     startRouter
// } from './api/index'

let nuxtConfig = __webpack_require__(46);
...
// 静态文件
app.use('/uploads', __WEBPACK_IMPORTED_MODULE_1_express___default.a.static('uploads'));
...
let nuxt = new __WEBPACK_IMPORTED_MODULE_0_nuxt__["Nuxt"](nuxtConfig);
if (true) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__account__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__topic__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__log__ = __webpack_require__(45);




const router = __WEBPACK_IMPORTED_MODULE_0__base__["b" /* default */].Router();
router.use('/account', __WEBPACK_IMPORTED_MODULE_1__account__["a" /* default */]);
router.use('/topic', __WEBPACK_IMPORTED_MODULE_2__topic__["a" /* default */]);
router.use('/logs', __WEBPACK_IMPORTED_MODULE_3__log__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mysql__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mysql___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mysql__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_index__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_index__ = __webpack_require__(4);


const pool = __WEBPACK_IMPORTED_MODULE_0_mysql___default.a.createPool(__WEBPACK_IMPORTED_MODULE_1__config_index__["a" /* sql */]);
...
class Sql {
	...
	insert(object) {
		...
		if (object) {
			...
			if (__WEBPACK_IMPORTED_MODULE_2__utils_index__["a" /* default */].isEmptyObject(object)) {
				return object;
			}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_crypto__ = __webpack_require__(40);
...
class Crypto {
	sha1(str) {
		const sha1 = __WEBPACK_IMPORTED_MODULE_0_crypto___default.a.createHash('sha1');
		sha1.update(str);
		return sha1.digest('hex');
	}

	hmac(str) {
		const buf = __WEBPACK_IMPORTED_MODULE_0_crypto___default.a.randomBytes(16); //随机buf
		const secret = buf.toString('hex'); //秘钥加密
		const signture = __WEBPACK_IMPORTED_MODULE_0_crypto___default.a.createHmac('sha1', secret); //定义加密方式
		signture.update(str);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_multer__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_utils_date__ = __webpack_require__(42);
...
class multerUtils {
	...
	instance(desc) {
		return __WEBPACK_IMPORTED_MODULE_0_multer___default()({
			storage: this.storage(desc)
		});
	}

	storage(desc) {
		return __WEBPACK_IMPORTED_MODULE_0_multer___default.a.diskStorage({
			...
			filename: function (req, file, cb) {
				...
				const t = Object(__WEBPACK_IMPORTED_MODULE_1__assets_utils_date__["b" /* formatDate */])(null, __WEBPACK_IMPORTED_MODULE_1__assets_utils_date__["a" /* DATE_STR */]);
				cb(null, `${file.fieldname}_${t}.${fileFormat.pop()}`);
			}
		});
	}
}
/* harmony default export */ __webpack_exports__["a"] = (new multerUtils());
...
/* unused harmony default export */ var _unused_webpack_default_export = (new FormatDate());
 ...
 *  @type {string}
 */
const DATE_NORMAL = "yyyy-MM-dd hh:mm:ss";
/* unused harmony export DATE_NORMAL */
 ...
 *  @type {string}
 */
const DATE_MM = "yyyy-MM-dd hh:mm";
/* unused harmony export DATE_MM */
 ...
 *  @type {string}
 */
const DATE_DD = "yyyy-MM-dd";
/* unused harmony export DATE_DD */


const DATE_STR = "yyyyMMddhhmmss";
/* harmony export (immutable) */ __webpack_exports__["a"] = DATE_STR;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_index__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_index__ = __webpack_require__(4);


const router = __WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].Router();
const sql = new __WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* Sql */]('account');

router.get('/all_user', async (req, res) => {
    try {
        const results = await sql.search();
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(200, results, 'success'));
    } catch (error) {
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10004, error, '服务器错误'));
    }
});
// 查询个人信息
router.get('/userinfo', async (req, res) => {
    try {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__utils_index__["a" /* default */].isEmpty(token)) {
            return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10003, 'token不存在', "未登录"));
        }
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__utils_index__["a" /* default */].isEmptyObject(results)) {
            return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10005, 'token错误', "登录失效，请重新登录"));
        }

        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(200, results[0], "查询成功"));
    } catch (e) {
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10004, e, "服务器错误"));
    }
});
...
router.post('/register', async (req, res) => {
    try {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__utils_index__["a" /* default */].isEmpty(account) || __WEBPACK_IMPORTED_MODULE_1__utils_index__["a" /* default */].isEmpty(password)) {
            return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10001, 'error', "请填写完整信息"));
        }
        ...
        if (!__WEBPACK_IMPORTED_MODULE_1__utils_index__["a" /* default */].isEmptyObject(isExist)) {
            return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10002, 'error', "该账号已存在，请重新输入账号"));
        }
        ...
        res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(200, 'success', "注册成功"));
    } catch (e) {
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10004, e, "服务器错误"));
    }
});
router.get('/logout', async (req, res) => {
    try {
        ...
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(200, null, '退出成功'));
    } catch (error) {
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10004, error, "服务器错误"));
    }
});
router.post('/login', async (req, res) => {
    try {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__utils_index__["a" /* default */].isEmptyObject(isExist)) {
            return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10003, 'error', "账号或密码错误"));
        }
        ...
        if (update.changedRows == 0) {
            return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(200, update, "更新失败"));
        }
        ...
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(200, null, "登录成功"));
    } catch (e) {
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10004, e, "服务器错误"));
    }
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_index__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_multer__ = __webpack_require__(16);
...
const router = __WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].Router();
const sql = new __WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* Sql */]('topic');
const topic_img = __WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].upload().single('topic_img'); // 名称一定要已有

router.post('/upload_images', (req, res) => {
    try {
        topic_img(req, res, err => {
            if (err instanceof __WEBPACK_IMPORTED_MODULE_1_multer___default.a.MulterError) {
                return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10006, '图片未找到', '上传失败'));
                // A Multer error occurred when uploading.
            } else if (err) {
                // An unknown error occurred when uploading.
                return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10006, err, '上传失败'));
            }
            if (req.file) {
                return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(200, {
                    path: req.file.path
                }, '上传成功'));
            }
            return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10006, '图片未找到', '上传失败'));
        ...
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10004, err, '服务器错误'));
    }
});
...
router.post('/', async (req, res) => {
    try {
        ...
        const token = req.cookies.token;
        let userinfo = await __WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].userinfo(token);
        ...
        if (__WEBPACK_IMPORTED_MODULE_0__base_index__["c" /* utils */].hasNullParams(data)) {
            return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10001, null, '请输入完整信息'));
        }
        ...
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(200, {}, 'success'));
    } catch (err) {
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10004, err, '服务器错误'));
    }
});
...
const router = __WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].Router();
const sql = new __WEBPACK_IMPORTED_MODULE_0__base_index__["a" /* Sql */]('sys_logs');
...
router.post('/create', async (req, res) => {
    try {
        ...
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(200, null, "查询成功"));
    } catch (e) {
        return res.json(__WEBPACK_IMPORTED_MODULE_0__base_index__["b" /* default */].returnJson(10004, e, "服务器错误"));
    }
});
...
module.exports = {"name":"nuxt-test","version":"1.0.0","description":"Nuxt.js project","author":"xingwen","private":true,"scripts":{"dev":"cross-env NODE_ENV=development backpack dev","dev_old":"nuxt","build":"nuxt build","start":"cross-env NODE_ENV=production pm2 start build/main.js","start_old":"nuxt start","generate":"nuxt generate","lint":"eslint --ext .js,.vue --ignore-path .gitignore .","precommit":"npm run lint","dev-debug":"node --debug node_modules/.bin/nuxt"},"dependencies":{"@types/vue":"^2.0.0","axios":"^0.18.1","cookie-parser":"^1.4.3","crypto":"^1.0.1","element-ui":"^2.4.8","express":"^4.16.4","express-winston":"^3.0.1","github-markdown-css":"^2.10.0","mavon-editor":"^2.6.17","mockjs":"^1.0.1-beta3","multer":"^1.4.1","mysql":"^2.16.0","nuxt":"^1.0.0","vue-markdown":"^2.2.4","vue-meditor":"^0.9.2","vue-meta":"^1.5.5","winston":"^3.1.0"},"devDependencies":{"@nuxtjs/axios":"^5.3.1","@nuxtjs/proxy":"^1.2.4","babel-eslint":"^8.2.1","backpack-core":"^0.7.0","cross-env":"^5.2.0","eslint":"^4.15.0","eslint-friendly-formatter":"^3.0.0","eslint-loader":"^1.7.1","eslint-plugin-vue":"^4.0.0","less":"^3.7.1","less-loader":"^4.1.0"}}
...
var unpipe = __webpack_require__(86)
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(13).concat(__webpack_require__(24)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(25).concat(__webpack_require__(83)) },
...
module.exports = {
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(27).concat(__webpack_require__(102)) },
        encodeSkipVals: [0xa2cc],
    },
